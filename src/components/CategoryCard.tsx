...
export function CategoryCard({ category }: { category: Category }) {
  return (
    <a href={`#/categories?category=${encodeURIComponent(category.name)}`} className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-1 hover:shadow-soft">
